...
It also has some basic understanding of inheritance, if you use full path to whatever is inherited, it will refresh files based on the inheritance tree. If you are carrying a copy of the item that is updated, it will also refresh that copy of the item. Like
